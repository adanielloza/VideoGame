...
public class CameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        halfHeight = Camera.main.orthographicSize; //gets half of the height of the camera
        halfWidth = halfHeight * Camera.main.aspect; //gets half of the width of the camera 
    }
